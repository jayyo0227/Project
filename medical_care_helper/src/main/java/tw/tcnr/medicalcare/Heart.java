...
//        bottomNav2.setSelectedItemId(R.id.nav_book);
        bottomNav3.setSelectedItemId(R.id.heartbeat);
    ...
    private void suvc() {
//        b_input = (Button)findViewById(R.id.btninput);
//        b_input.setOnClickListener(this);
    }
    @Override
    public void onClick(View v) {
        Intent it = new Intent();
//        it.setClass(Heart.this, tw.tcnr26.sign.Heart_input.class);
