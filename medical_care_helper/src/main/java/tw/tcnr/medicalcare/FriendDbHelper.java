...
public class FriendDbHelper extends SQLiteOpenHelper {
    ...
    private static final String crTBsql_case_info = "CREATE     TABLE   " + DB_TABLE_case_info + "   ( "
            + " id    INTEGER   PRIMARY KEY , " + " t001 TEXT ," + " t002 TEXT ," + " t003 TEXT ," + " t004 TEXT , "
            + " t005 TEXT , " + " t006 TEXT , " + " t007 TEXT , " + " t008 TEXT , " + " t009 TEXT );";
    //----------------news--------------------------------------------------------------------------------------------------------------------------------------
    ...
    //----------------record--------------------------------------------------------------------------------------------------------------------------------------
    private static final String DB_TABLE_record = "record";    // 資料庫物件，固定的欄位變數
