...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    private void setupViewComponent() {
        ...
        bottomNav3 = findViewById(R.id.nav_view3); // 服務紀錄 血壓 體重 心跳
        bottomNav4 = findViewById(R.id.nav_view4); // 基本資料 訪查資訊 注意事項 合約資訊 返回
        ...
        BottomNavigationHelper.removeShiftMode(bottomNav3); // 要用這方式才能顯示文字
        ...
        bottomNav3.setVisibility(View.GONE);  //先隱藏
        bottomNav4.setVisibility(View.GONE);  //先隱藏
...
//            u_menu_login(); //有成功才有登出  這邊不能跑
    ...
    private Button.OnClickListener signupDlgBtnCancelOnClkLis = new Button.OnClickListener()
    {
        public void onClick(View v)
        {
            Toast.makeText(getApplicationContext(), "你已取消註冊!", Toast.LENGTH_LONG).show();
            mLoginDlg.cancel();
        }
    };
    private Button.OnClickListener signinDlgBtnCancelOnClkLis = new Button.OnClickListener()
    {
        public void onClick(View v)
        {
            Toast.makeText(getApplicationContext(), "你已取消登入!", Toast.LENGTH_LONG).show();
//            a04_t001.setText(getString(R.string.a04_t001_1) +"  " +getString(R.string.a04_t001_2));
    ...
    private Button.OnClickListener resetBtnCancelOnClkLis = new Button.OnClickListener()
    {
        public void onClick(View v)
        {
            Toast.makeText(getApplicationContext(), "您已取消修改重設密碼!", Toast.LENGTH_SHORT).show();
            mLoginDlg.cancel();
        }
    };
    ...
    private Button.OnClickListener modifyBtnCancelOnClkLis = new Button.OnClickListener()
    {
        public void onClick(View v)
        {
            Toast.makeText(getApplicationContext(), "您已取消修改資料!", Toast.LENGTH_SHORT).show();
            mLoginDlg.cancel();
        }
    };
    //=================================================================================================================
...
//            a04_t001.setText(test);
    ...
    {   //抓dialog上的EditText
        ...
        if(!email.getText().toString().equals(""))  //
        {
            ...
            {// 查看帳號有無重複
                email.setText("");
                Toast.makeText(getApplicationContext(), "帳號已重複!,請重新輸入", Toast.LENGTH_SHORT).show();
            }
            else if(t_email.equals("") || t_username.equals("") || t_password.equals("") || t_rpassword.equals(""))  //不可空白 要用.equals("")
            {// 資料不得空白
                Toast.makeText(getApplicationContext(), "資料不得空白!", Toast.LENGTH_SHORT).show();
            }
...
//                        Toast.LENGTH_SHORT).show();
    ...
    private void modify_mysql_update()
    {
        ...
        Toast.makeText(getApplicationContext(), "資料已修改完成,請重新登入!", Toast.LENGTH_SHORT).show();
...
//        mStatusTextView.setText(test+" 您好");
    ...
    private void resetpassword_mysql_update()
    {
        ...
        {
            Toast.makeText(getApplicationContext(), "密碼不得空白", Toast.LENGTH_LONG).show();
        }
        ...
        else
        {
            ...
            Toast.makeText(getApplicationContext(), "密碼已修改完成,請重新登入!", Toast.LENGTH_SHORT).show();
...
//        mStatusTextView.setText(test+" 您好");
    ...
    private void sign_in_verification()
    {
        ...
        {
            Toast.makeText(getApplicationContext(), "帳號或密碼不得為空白!", Toast.LENGTH_SHORT).show();
...
//                	MODE_MULTI_PROCESS	允許多個 process 同時存取
            ...
            {
//                a04_t001.setText(getString(R.string.a04_t001_3));
                Toast.makeText(getApplicationContext(), "帳號密碼有誤!", Toast.LENGTH_SHORT).show();
            }
        }
    }
