...
public class Case_info_contract extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.case_info_contract);
        setupViewComponent();
    }
...
//        ------------------------------------------------------------------------------------------------------------
        t001=(TextView)findViewById(R.id.b05_t001);
        t002=(TextView)findViewById(R.id.b05_t002);
        t003=(TextView)findViewById(R.id.b05_t003);
        img001=(ImageView)findViewById(R.id.b05_img001);
        t001.setText(getString(R.string.b05_t001)+"2020年1月1日");
        t002.setText(getString(R.string.b05_t002)+"2020年12月31日");
        t003.setText(getString(R.string.b05_t003)+"XXXX元");
    }
...
//    6.最後完全結束Activity之前，呼叫onDestroy方法。
    ...
    protected void onStop() {
        super.onStop();
        Case_info_contract.this.finish();
